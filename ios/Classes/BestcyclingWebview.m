...
// Al cambiar la url la enviamos al listener
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    NSString *urlString = [NSString stringWithString:[[request URL] relativeString]];
    BOOL isInvalid = [self checkInvalidUrl: [request URL]];;

    id data = @{@"url": urlString,
...
- (void)webView:(UIWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction
...
- (WKWebView *)webView:(WKWebView *)webView createWebViewWithConfiguration: configuration
