...
class WebviewManager {
    ...
    WebviewManager(final Activity activity, final Context context) {
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    case KeyEvent.KEYCODE_BACK:
                        if (webView.canGoBack()) {
                            ...
                            BestcyclingWebview.channel.invokeMethod("onBack", null);
                        }
                        return true;
                    }
                }
        ...
        ((ObservableWebView) webView).setOnScrollChangedCallback(new ObservableWebView.OnScrollChangedCallback() {
            public void onScroll(int x, int y, int oldx, int oldy) {
                ...
                BestcyclingWebview.channel.invokeMethod("onScrollYChanged", yDirection);
                Map<String, Object> xDirection = new HashMap<>();
                xDirection.put("xDirection", (double) x);
                BestcyclingWebview.channel.invokeMethod("onScrollXChanged", xDirection);
            }
        });
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int progress) {
                ...
                BestcyclingWebview.channel.invokeMethod("onProgressChanged", args);
            }
        });
    }
    ...
    void openUrl(boolean withJavascript, boolean clearCache, boolean hidden, boolean clearCookies, String userAgent,
            ...
            boolean supportMultipleWindows, boolean appCacheEnabled, boolean allowFileURLs, boolean useWideViewPort,
            String invalidUrlRegex, boolean geolocationEnabled) {
    ...
    void close(MethodCall call, MethodChannel.Result result) {
        ...
        closed = true;
        BestcyclingWebview.channel.invokeMethod("onDestroy", null);
    }
